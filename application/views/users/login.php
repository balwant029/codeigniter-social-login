...
<?php    echo form_open('users/login', ['id' => 'login']); ?>
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="<?php echo $fb_url; ?>" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using Facebook</a>
      <a href="<?php echo $ga_url; ?>" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using Google+</a>
    </div>
    <!-- /.social-auth-links -->
